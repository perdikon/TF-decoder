...
class Encoder(nn.Module):
  def __init__(self, trace_attributes, num_activities, num_resources, num_lstm_layers,
               ...
               is_conditional, pad_activity_idx, pad_resource_idx):
  ...
  def forward(self, x, c=None, tuple_inputs=None):
    ...
    e_attrs = torch.cat((*e_attrs,), dim=1 ) #needs to be in the same device
